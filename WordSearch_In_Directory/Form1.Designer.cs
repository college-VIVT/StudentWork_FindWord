...
namespace WordSearch_In_Directory
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Укажите слово которе хотите найти (учитывается регистр):";
			// 
			// label1
			// 
			...
			this.label1.Text = "Укажите путь к директории:";
			// 
			// textBox3
			// 
			...
			this.textBox3.Size = new System.Drawing.Size(641, 265);
			...
			this.Text = "WordSearch_In_Directory";
